...
public class UserTotalScoreCard extends PolymerTemplate<MatchBindingModel> {
	...
	private final UserTotalScoreBean bean;
	private final BehaviorSubject<UserTotalScoreBean> kudo;
	...
	public UserTotalScoreCard(UserTotalScoreBean bean, BehaviorSubject<UserTotalScoreBean> kudo) {
		this.bean = bean;
		this.kudo = kudo;
	...
	private void initLayout() {
		LayoutUtil.initUserH4(user, bean.getUser(), bean.getPosition() + ". " + bean.getUser().getUsername());
