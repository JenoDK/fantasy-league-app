...
import com.jeno.fantasyleague.backend.data.service.leaguetemplates.fifaworld2026.FifaWorldCup2026Service;
...
public class LeagueTemplateConfig {
	...
	public static final String FIFA_WORLD_CUP_2026 = "FifaWorldCup2026Service";
	public static final String CUSTOM = "CustomTemplateService";

	@Bean(name = FIFA_WORLD_CUP_2026)
	public FifaWorldCup2026Service getFifaWorldCup2026Service() {
		return new FifaWorldCup2026Service();
	}
