...
public class FifaWorldCup2026Service implements LeagueTemplateService {

	@Autowired
	private FootballSettingsRenderer fifaWorldCup2026SettingRenderer;
	@Autowired
	private FifaWorldCup2026Initializer fifaWorldCup2026Initializer;
	@Autowired
	private FootballLeagueScoreHelper footballLeagueScoreHelper;

	@Override
	public LeagueSettingRenderer getLeagueSettingRenderer() {
		return fifaWorldCup2026SettingRenderer;
	}
	...
	public void run(League newLeague, User user) throws TemplateException {
		fifaWorldCup2026Initializer.addNewLeague(newLeague, user);
	}
