...
//				.get());
		...
		ArrayListMultimap<SoccerCupStages, LeagueSetting> leagueSettingPerGroup =
				SoccerCupStages.getLeagueSettingsPerStage(allLeagueSettings);
		leagueSettingPerGroup.keySet().stream()
				.sorted(Comparator.comparing(SoccerCupStages::getSeq))
				.forEach(stage -> {
...
//		powerIndexModifier.addClassName(ValoTheme.TEXTFIELD_TINY);
	...
	public void addDefaultLeagueSettings(League newLeague) {
		...
		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.GROUP_PHASE.getName() + ALL_CORRECT, 3));
		...
		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.QUARTER_FINALS.getName() + ALL_CORRECT, 10));
		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.QUARTER_FINALS.getName() + WRONG_SCORE, 7));
		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.QUARTER_FINALS.getName() + ALL_WRONG, 0));

		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.SEMI_FINALS.getName() + ALL_CORRECT, 15));
		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.SEMI_FINALS.getName() + WRONG_SCORE, 10));
		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.SEMI_FINALS.getName() + ALL_WRONG, 0));

		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.FINALS.getName() + ALL_CORRECT, 30));
		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.FINALS.getName() + WRONG_SCORE, 20));
		labSettings.add(createLeagueScoreSettings(newLeague, SoccerCupStages.FINALS.getName() + ALL_WRONG, 0));
